                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/trepadora/parthenocissus_quinquefolia_parra_virgen_4,50.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>PARTHENOCISSUS QUINQUEFOLIA (PARRA VIRGEN)</h3>
                            <br>
                            <br>
                             <h2>4,50 €</h2>
                             <br>
                             <h5>Referencia: PT-7</h5>
                             <h7> Disponibilidad: En existencias</h7>
                             <br>
                             <h3>¿Te interesa?</h3>
                             ...
                             <h7>PARTHENOCISSUS QUINQUEFOLIA (PARRA VIRGEN)</h7>
                             <br>
                             <br>
                             <h8>Tiene entre 175/200 cm de altura y 3 Litros de maceta</h8>
                        </div>
                      </div>
