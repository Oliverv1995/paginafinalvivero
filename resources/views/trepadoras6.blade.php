                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/trepadora/solamun_jasminoides_4,50.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>SOLAMUN JASMINOIDES (FALSO JAZMÍN))</h3>
                            <br>
                            <br>
                             <h2>4,50 €</h2>
                             <br>
                             <h5>Referencia: PT-10</h5>
                             ...
                             <h7>SOLAMUN JASMINOIDES (FALSO JAZMÍN)</h7>
                             <br>
                             <br>
                             <h8>Tiene 125/150 cm de altura y 3 Litros de maceta</h8>
                        </div>
                      </div>
