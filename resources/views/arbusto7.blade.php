                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/arbustos/phormiun_tenax_18,85.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>PHORMIUN TENEX</h3>
                            <br>
                            <br>
                             <h2>8,85 €</h2>
                             <br>
                             <h5>Referencia: A61</h5>
                             ...
                             <h8>TIENE ENTRE 80/100 CM DE ALTURA DE ARBUSTO Y ENTRE 3 Y 5 LITROS DE VOLUMEN DE MACETA.</h8>
                        </div>
                      </div>
