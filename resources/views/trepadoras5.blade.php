                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/trepadora/rhynchospermum_jasminoides_jazm_n_5,25.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>RHYNCHOSPERMUM JASMINOIDES (JAZMÍN)</h3>
                            <br>
                            <br>
                             <h2>5,25 €</h2>
                             <br>
                             <h5>Referencia: PT-9</h5>
                             ...
                             <h7>RHYNCHOSPERMUM JASMINOIDES (JAZMÍN)</h7>
                             <br>
                             <br>
                             <h8>Tiene entre 80/100, 125/150 y 175/200 cm de altura y 3 Litros de maceta</h8>
                        </div>
                      </div>
