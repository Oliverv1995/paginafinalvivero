                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/trepadora/wisteria_sinensis_glicinia_6,75.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>WISTERIA SINENSIS (GLICINIA)</h3>
                            <br>
                            <br>
                             <h2>6,75 €</h2>
                             <br>
                             <h5>Referencia: PT-11</h5>
                             ...
                             <h7>WISTERIA SINENSIS (GLICINIA)</h7>
                             <br>
                             <br>
                             <h8>Tiene 175/200 cm de altura y 3 Litros de maceta</h8>
                        </div>
                      </div>
