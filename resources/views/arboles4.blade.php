                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/vivero/ailanthus_altissima_1_218,00.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>AILANTHUS ALTISSIMA</h3>
                            <br>
                            <br>
                             <h2>45,00 €</h2>
                             <br>
                             <h5>Referencia: A0010</h5>
                             ...
                             <h8>TIENE ENTRE 8 Y 16M DE ALTURA.</h8>
                        </div>
                      </div>
