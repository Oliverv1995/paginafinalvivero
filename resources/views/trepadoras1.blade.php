                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/trepadora/campsis_radicans_5,93.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>COMPSIS RADICANS (BIGNONIA)</h3>
                            <br>
                            <br>
                             <h2>5,93 €</h2>
                             <br>
                             <h5>Referencia: PT-1</h5>
                             ...
                             <h7> COMPSIS RADICANS (BIGNONIA)</h7>
                             <br>
                             <br>
                             <h8>Tiene entre 100/150 cm de altura y entre 1 Litro de maceta</h8>
                        </div>
                      </div>
