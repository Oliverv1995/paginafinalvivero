                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/vivero/acacia_dealbata_1_167,50.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>ACACIA DEALBATA</h3>
                            <br>
                            <br>
                             <h2>67,50 €</h2>
                             <br>
                             <h5>Referencia: Ar1</h5>
                             ...
                             <h8>TIENE ENTRE 10/12, 12/14, 14/16 Y 16/18 CM DE DIÁMETRO DE TRONCO.</h8>
                        </div>
                      </div>
