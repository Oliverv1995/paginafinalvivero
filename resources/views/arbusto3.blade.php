                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/arbustos/ligustrum_ovalifolium0,35.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>LIGUSTRUM OVALIFOLIUM</h3>
                            <br>
                            <br>
                             <h2>0,35 €</h2>
                             <br>
                             <h5>Referencia: A55</h5>
                             ...
                             <h8>TIENE ENTRE 100/125 Y 125/150 CM DE ALTURA DE ARBUSTO, ENTRE 2 Y 30 L DE MACETA Y DE VARIOS TALLOS</h8>
                        </div>
                      </div>
