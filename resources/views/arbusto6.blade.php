                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/arbustos/philadelphus_virginalis2,25.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>PHILADELPHUS VIRGINALIS (CELINDO)</h3>
                            <br>
                            <br>
                             <h2>2,25 €</h2>
                             <br>
                             <h5>Referencia: A59</h5>
                             ...
                             <h8>TIENE ENTRE 80/100 Y 100/125 CM DE ALTURA DE ARBUSTO Y ENTRE 1 Y 3 LITROS DE VOLUMEN DE MACETA.</h8>
                        </div>
                      </div>
