                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/arbustos/pachysandra_terminalis1,00.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            ...
                            <br>
                             ...
                             <h8>TIENE ENTRE 10/20 Y 20/30 CM DE ALTURA DE ARBUSTO, 1 L DE MACETA.</h8>
                        </div>
                      </div>
