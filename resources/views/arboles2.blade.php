                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/vivero/aesculus_hippocastanum_casta_o_de_indias__236,00.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>AESCULUS HIPPOCASTANUM (CASTAÑO DE INDIAS)</h3>
                            <br>
                            <br>
                             <h2>54,00 €</h2>
                             <br>
                             <h5>Referencia: A0007</h5>
