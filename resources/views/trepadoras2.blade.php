                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/trepadora/jasminum_nudiflorum_amarillo_jazm_n_4,10.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>JASMINUM NUDIFLORUM(AMARILLO) (JAZMÍN)</h3>
                            <br>
                            <br>
                             <h2>4,10 €</h2>
                             <br>
                             <h5>Referencia: PT-5</h5>
                             ...
                             <h7> JASMINUM NUDIFLORUM(AMARILLO) (JAZMÍN)</h7>
                             <br>
                             <br>
                             <h8>Tiene entre 150/175 cm de altura y 3 Litros de maceta</h8>
                        </div>
                      </div>
