                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/arbustos/lagerstroemia_indica_8,60.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>LAGERSTROEMIA INDICA (ÁRBOL DE JÚPITAR)</h3>
                            <br>
                            <br>
                             <h2>8,60 €</h2>
                             <br>
                             <h5>Referencia: A54</h5>
                             ...
                             <h8>TIENE ENTRE 100/125, 150/175 Y 300/350 CM DE ALTURA DE ARBUSTO Y ENTRE 10 Y 70 L DE MACETA</h8>
                        </div>
                      </div>
