                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/trepadora/lonicera_nitida_madreselva_1,35.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>LONICERA NITIDA (MADRESELVA)</h3>
                            <br>
                            <br>
                             <h2>1,35 €</h2>
                             <br>
                             <h5>Referencia: PT-6</h5>
                             ...
                             <h7>LONICERA NITIDA (MADRESELVA)</h7>
                             <br>
                             <br>
                             <h8>Tiene entre 30/40 y 175/200 cm de altura y 1 y 3 Litros de maceta</h8>
                        </div>
                      </div>
