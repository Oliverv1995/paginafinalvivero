                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/vivero/acer_platanoides_arce_real__314,25.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>ACER SACCHARINUM (ARCE PLATEADO)</h3>
                            <br>
                            <br>
                             <h2>12,25 €</h2>
                             <br>
                             <h5>Referencia:  Ar7</h5>
                             ...
                             <h8>TIENE ENTRE 8/10, 10/12, 12/14, 14/16 Y 16/18 CM DE DIÁMETRO DE TRONCO.</h8>
                        </div>
                      </div>
