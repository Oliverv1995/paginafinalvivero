                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/arbustos/crataegus_monogyna2,60.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>CRATAEGUS MONOGYNA</h3>
                            <br>
                            <br>
                             <h2>2,60 €</h2>
                             <br>
                             <h5>Referencia: A43</h5>
                             ...
                             <h8>TIENE ENTRE 80/100 CM DE ALTURA DE ARBUSTO Y 3 LITROS DE MACETA.</h8>
                        </div>
                      </div>
