                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/arbustos/pieris_japonica7,10.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>PIERIS JAPONICA (MIX)</h3>
                            <br>
                            <br>
                             <h2>7,10 €</h2>
                             <br>
                             <h5>Referencia: A60</h5>
                             ...
                             <h8>TIENE ENTRE 40/60 Y 60/80 CM DE ALTURA DE ARBUSTO Y ENTRE 3 Y 5 LITROS DE VOLUMEN DE MACETA.</h8>
                        </div>
                      </div>
