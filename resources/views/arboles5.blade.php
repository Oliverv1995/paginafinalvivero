                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/vivero/albizia_julibrissin_acacia_de_constantinopla__239,00.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>ALBIZIA JULIBRISSIN(ACACIA DE CONSTANTINOPLA)</h3>
                            <br>
                            <br>
                             <h2>54,00 €</h2>
                             <br>
                             <h5>Referencia: A0011</h5>
                             ...
                             <h8>TIENE ENTRE 10 Y 25M DE ALTURA.</h8>
                        </div>
                      </div>
