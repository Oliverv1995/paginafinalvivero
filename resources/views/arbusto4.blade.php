                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/arbustos/magnolia_soulangeana21,75.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            ...
                            <br>
                             ...
                             <h8>TIENE ENTRE 100/125 Y 200/250 CM DE ALTURA DE ARBUSTO, ENTRE 10 Y 30 L DE MACETA</h8>
                        </div>
                      </div>
