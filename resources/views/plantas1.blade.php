                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/plantas/lavandula1,50.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                                <h5 class="card-title">LAVANDULA "LAVANDA"</h5>
                                <p class="card-text">1,50 €</p>
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>LAVANDULA "LAVANDA"</h3>
                            <br>
                            <br>
                             <h2>1,50 €"</h2>
                             <br>
                             <h5>Referencia: AR00001</h5>
                             ...
                             <h7> ANGUSTIFOLIA. DENTATA, HÍBRIDA, OFFICINALIS Y STOECHAS</h7>
                             <br>
                             <br>
                             <h8>Tiene entre 20 y 80 cm de altura de tronco de planta.</h8>
                        </div>
                      </div>
