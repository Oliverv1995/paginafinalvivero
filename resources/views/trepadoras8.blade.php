                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="card" style="width: 18rem;">
                              </center><img src="img/trepadora/passiflora_pasionar_3,00.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <h3>PASSIFLORA (PASIONARÍA)</h3>
                            <br>
                            <br>
                             <h2>3,00 €</h2>
                             <br>
                             <h5>Referencia: PT-8</h5>
